...
bool ParseCommand(int argc, char* argv[], string &input_points_file, string &output_stat_file, int &neighbors, float &subsample, int &finalvec)
{
	try
	{
		...
		desc.add_options()
			...
			(",o", po::value<std::string>(&output_stat_file)->default_value(""), "The output file name")
...
void extracthighesbar(string input, string output, int num)
{
...
int main(int argc,  char * argv[]) 
{
    ...
    int max_dim=2, neighbors=20, finalvec=10;
    float subsample=17;


    ParseCommand(argc, argv, input_points_file, output_stat_file, neighbors, subsample, finalvec);
    // ParseCommand(argc, argv, input_image, output_image_folder, neighbors, , subsample)
    ...
    extracthighesbar((points_name+"_pers"), output_stat_file, finalvec);
